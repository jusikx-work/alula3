function t_sldsInit(t, s) {
  ...
  isNaN(c) && n.attr("data-slider-transition", "300"),
    n.hasClass("t-slds_animated-fast") ||
      n.hasClass("t-slds_animated-slow") ||
      n.hasClass("t-slds_animated-none") ||
      n.addClass("t-slds_animated-fast");
  var m = o;
  ...
  var u = window.navigator.userAgent,
    ...
    c = !1;
  0 < w &&
    ((8 != (f = parseInt(u.substring(w + 5, u.indexOf(".", w)))) && 9 != f) ||
      (c = !0)),
    !0 === c &&
      (n
        .removeClass("t-slds_animated-fast")
        .removeClass("t-slds_animated-slow")
        .addClass("t-slds_animated-none t-slds_ie")
        .attr("data-slider-correct-height", "true"),
  ...
  (u = !1),
    (w = i.find('[data-zoomable="yes"]')),
    (f = r.find('[data-zoomable="yes"]'));
  if (
    ((w || f) &&
      ((u = !0),
      w.removeClass("t-zoomable").removeAttr("data-zoomable"),
      f.removeClass("t-zoomable").removeAttr("data-zoomable")),
    0 == e.find(".t-slds__item[data-slide-index=0]").length &&
      (i.before(r.clone(!0).attr("data-slide-index", "0")),
      i
        .parent()
        .find("[data-slide-index=0]")
        .find("[field]")
        .removeAttr("field")),
  ...
  u &&
    (w.addClass("t-zoomable").attr("data-zoomable", "yes"),
    f.addClass("t-zoomable").attr("data-zoomable", "yes")),
    (o = n.attr("data-slider-items-in-row") || 0),
    "false" === _ && d - o <= 0
      ? e.find(".t-slds__arrow_wrapper-right").css("display", "none")
      : e.find(".t-slds__arrow_wrapper-right").css("display", ""),
    ...
    $(window).on("load", function () {
      "true" == n.attr("data-slider-correct-height") &&
...
function t_slds_setItemsInRow(t, s) {
  var e,
    t = ("object" == typeof t ? t : $("#rec" + t)).find(
      ".t-slds__items-wrapper"
    );
  (t.attr("data-slider-items-in-row") || 0) &&
    (window.innerWidth <= 960 && (e = 2),
    window.innerWidth <= 640 && (e = 1),
    960 < window.innerWidth && (e = s)),
    e && t.attr("data-slider-items-in-row", e);
}
function t_slds_initSliderControls(i, r) {
  var l = "object" == typeof i ? i : $("#rec" + i),
    n = l.find(".t-slds__items-wrapper"),
    t = (
      0 < (n.attr("data-slider-items-in-row") || 0)
        ? l.find(".t-slds__container .t-slds__item")
        : l.find(".t-slds__container")
    ).width();
    ...
    l.find(".t-slds__arrow_wrapper").click(function () {
      ...
      "" == s &&
        ...
        "left" === $(this).attr("data-slide-direction")
          ? "false" == n.attr("data-slider-with-cycle") && 1 == e
            ? (e = 1)
            : e--
          : "false" == n.attr("data-slider-with-cycle") && e == a
          ? (e = a)
          : e++,
  ...
  requestAnimationFrame(function t(s) {
    ...
    d(s),
      e < 1
        ...
        : ("y" !== window.lazy &&
            "yes" !== $("#allrecords").attr("data-tilda-lazy")) ||
...
function t_slide_MoveAnimation(s, t, e, a) {
  var d, i;
  s[0] &&
    ((s[0].style.transition =
      "height ease-in-out .5s, transform ease-in-out 0s"),
    (e = -Math.abs(t * e)),
...
function t_slideMoveWithoutAnimation(t, s, e) {
  var a,
    ...
    l = (
      0 < (i.attr("data-slider-items-in-row") || 0)
        ? d.find(".t-slds__container .t-slds__item")
        : d.find(".t-slds__container")
    ).width(),
...
function t_slideMoveInstantly(t, s, e) {
  var a = "object" == typeof t ? t : $("#rec" + t),
    ...
    r = (
      0 < (d.attr("data-slider-items-in-row") || 0)
        ? a.find(".t-slds__container .t-slds__item")
        : a.find(".t-slds__container")
    ).width(),
...
function t_slideMove(t, s, e) {
  var a = "object" == typeof t ? t : $("#rec" + t),
    ...
    _ =
      (d.attr("data-slider-cycle"),
      a.find(".t-slds__items-wrapper").hasClass("t-slds_animated-none")),
    c = 0 < d.attr("data-slider-timeout"),
    f = d.attr("data-slider-stop");
  if (
    (l || 0 === l || (l = 300),
    o + 1 < n && ((n = 1), d.attr("data-slider-pos", 1)),
    "true" == f)
  )
    return !1;
  "false" == d.attr("data-slider-with-cycle") &&
  (n == o || (1 < i && n == o - i + 1))
    ? a.find(".t-slds__arrow_wrapper-right").fadeOut(300)
    : a.find(".t-slds__arrow_wrapper-right").fadeIn(300),
    "false" == d.attr("data-slider-with-cycle") && 1 == n
      ? a.find(".t-slds__arrow_wrapper-left").fadeOut(300)
      : a.find(".t-slds__arrow_wrapper-left").fadeIn(300),
    d.addClass("t-slds_animated"),
    window.isSafariVersion &&
    13 <= window.isSafariVersion[0] &&
    window.isiOSChrome &&
    !_
      ? t_slide_MoveAnimation(d, n, r, l)
      : d.css({ transform: "translateX(-" + r * n + "px)" }),
    setTimeout(function () {
...
function t_slds_updateSlider(t) {
  ...
  var e = s.find(".t-slds__items-wrapper"),
    ...
    d = (
      0 < a
        ? s.find(".t-slds__container .t-slds__item")
        : s.find(".t-slds__container")
    ).width(),
  ...
  r + 1 < i && ((i = 1), e.attr("data-slider-pos", 1)),
    "false" === l && r - a <= 0
      ? s.find(".t-slds__arrow_wrapper-right").css("display", "none")
      : s.find(".t-slds__arrow_wrapper-right").css("display", ""),
    e.css({ transform: "translateX(-" + d * i + "px)" }),
    "true" == e.attr("data-slider-correct-height") &&
      t_slds_UpdateSliderHeight(t),
    t_slds_UpdateSliderArrowsHeight(t);
}
function t_slds_UpdateImages(t, s) {
  s = ("object" == typeof t ? t : $("#rec" + t)).find(
    '.t-slds__item[data-slide-index="' + s + '"]'
  );
...
function t_slds_ActiveCaption(t, s, e) {
  ...
  d.removeClass("t-slds__caption-active"),
    0 == s
      ? (t = a.find('.t-slds__caption[data-slide-caption="' + e + '"]'))
      : s == e + 1 && (t = a.find('.t-slds__caption[data-slide-caption="1"]')),
    t.addClass("t-slds__caption-active");
}
function t_slds_scrollImages(t, s) {
  (t = "object" == typeof t ? t : $("#rec" + t)),
    (s = (s < 0 ? "" : "-") + Math.abs(s).toString());
  t.find(".t-slds__items-wrapper").css("transform", "translateX(" + s + "px)");
}
function t_slds_ActiveBullet(t, s, e, a) {
  var d;
  a &&
    a.thumbsbulletGallery &&
    ((i = parseInt(a.storeOptions.popup_opts.columns)),
  ...
  r.removeClass("t-slds__bullet_active"),
    (a && a.thumbsbulletGallery && d <= s && s != e + 1) || (d <= e && 0 == s)
      ...
      : s == e + 1 &&
        (t = i.find('.t-slds__bullet[data-slide-bullet-for="1"]')),
...
function t_slds_ActiveSlide(t, s, e) {
  ...
  a.find("iframe").each(function (t, s) {
    s.src &&
      (-1 !== s.src.indexOf("&enablejsapi=1") &&
        s.contentWindow.postMessage(
          '{"event":"command","func":"pauseVideo","args":""}',
          "*"
        ),
      -1 === s.src.indexOf("vimeo") ||
        (-1 === s.src.indexOf("&amp;api=1") &&
          -1 === s.src.indexOf("&api=1")) ||
        s.contentWindow.postMessage('{"method":"pause","value":"true"}', "*"));
  }),
    d.removeClass("t-slds__item_active"),
    0 == s && !1 === t
      ? a
          .find('.t-slds__item[data-slide-index="' + e + '"]')
          .addClass("t-slds__item_active")
      : 0 == s && !0 === t
      ? (i = a.find('.t-slds__item[data-slide-index="' + e + '"]'))
      : s == e + 1 && !1 === t
      ? a
          .find('.t-slds__item[data-slide-index="1"]')
          .addClass("t-slds__item_active")
      : s == e + 1 &&
        !0 === t &&
        (i = a.find('.t-slds__item[data-slide-index="1"]')),
...
function t_slds_SliderWidth(t) {
  ...
  if ("true" == t) return !1;
  s.find(".t-slds__items-wrapper").width(e * a),
    window.innerWidth <= 640
      ? (d = 1)
      : window.innerWidth <= 960 && 1 < d && (d = 2);
  e = 1 < d ? e / d : e;
...
function t_slds_SliderHeight(t) {
  var s = "object" == typeof t ? t : $("#rec" + t),
    t = s
      ...
      .not('[data-slider-correct-height="false"]'),
...
function t_slds_initAutoPlay(d, i, r, l) {
  var a = "object" == typeof d,
    ...
    c =
      (n.find(".t-slds__items-wrapper").hasClass("t-slds_animated-none"),
      o.attr("data-slider-interval-id"));
  ...
  $(window).resize(
    ...
    void 0 !== document.hidden
      ...
      : void 0 !== document.webkitHidden &&
        ((f = "webkitHidden"), (p = "webkitvisibilitychange")),
    document.addEventListener(
      ...
      function () {
        ...
        document[f]
          ? o.attr("data-slider-stopped", "yes")
          : ((t = n.css("display")),
            (e = (s = $(window).scrollTop()) + $(window).height()),
            (m = n.offset().top),
            s < m + n.outerHeight() &&
              m < e &&
              "none" !== t &&
    ...
    window.removeEventListener("touchmove", t, { passive: !1 }),
      ...
      hammer.on("pan", function (t) {
        ...
        var s = f.find(".t-slds__items-wrapper"),
          ...
          d = (
            a
              ? f.find(".t-slds__container .t-slds__item")
              : f.find(".t-slds__container")
          ).width(),
        ...
        s.attr("data-slider-touch", "yes"),
          ...
          t.isFinal &&
            (0.4 < t.velocityX
              ? ("false" == s.attr("data-slider-with-cycle") && 1 == i
                  ? (i = 1)
                  : i--,
                s.attr("data-slider-pos", i),
                0 == i && (l = "yes"),
                s.attr("data-slider-cycle", l))
              : t.velocityX < -0.4 || o <= -30 / r
              ? ("false" == s.attr("data-slider-with-cycle") &&
                (i == r || (a && i == r - e + 1))
                  ? (i = a ? r - e : r)
                  : i++,
                s.attr("data-slider-pos", i),
  ...
  ("object" == typeof t ? t : $("#rec" + t))
    ...
    .each(function () {
      ...
      void 0 !== t.attr("data-src") &&
        ((t = $(this)).attr("src", t.attr("data-src")),
