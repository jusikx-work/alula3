        ...
        if (
          ...
          if (
            (r ||
              (r =
                "/tilda/click/" +
                ((t = t.closest(".r")) ? t.getAttribute("id") : "") +
                "/?url=" +
                d),
            Tilda.sendEventToStatistics(r, a),
            "http" === d.substring(0, 4))
          )
            return (
    ...
    (Tilda.sendEcommerceEvent = function (e, t) {
      ...
      for (
        ...
        "" < d && (d += ", "),
          ...
          void 0 !== i.options &&
            0 < i.options.length &&
            Array.prototype.forEach.call(i.options, function (e) {
              a += e.option + ": " + e.variant + "; ";
            });
        var s = { name: i.name, price: i.price, variant: a, quantity: 1 };
      ...
      ("add" !== e && "remove" !== e) ||
        ...
        ((s = { ecommerce: {} }).ecommerce[e] = { products: o }),
      ...
      (Tilda.sendEventToStatistics = function (e, t, r, a) {
        ...
        (w = document.getElementById("allrecords")) &&
          (m =
            null !== w.getAttribute("data-fb-event")
        ...
        w &&
          (o =
            null !== w.getAttribute("data-vk-event")
        ...
        var n,
          ...
          l = w.getAttribute("data-tilda-currency")
            ...
            for (var u = 0; u < d.length; u++)
              d[u].id ||
                (d[u].sku
                  ...
                  : d[u].recid &&
                    d[u].lid &&
                    (d[u].id = d[u].recid + "_" + d[u].lid));
            r.ecommerce.add && r.ecommerce.add.products
              ? ((r.ecommerce.add.products = d), (r.event = "addToCart"))
              : r.ecommerce.remove && r.ecommerce.remove.products
              ? ((r.ecommerce.remove.products = d),
            ...
            if (r && r.event) {
              try {
                if (
                  ...
                  for (
                    var s = r.ecommerce.purchase.products.length, p = 0;
                    p < s;
                    p++
                  )
                    (g = r.ecommerce.purchase.products[p]),
                      ga("ec:addProduct", {
                        id: g.id || p,
                        name: g.name,
                  ...
                  for (
                    s = r.ecommerce.remove.products.length, p = 0;
                    p < s;
                    p++
                  )
                    (g = r.ecommerce.remove.products[p]),
                      ga("ec:addProduct", {
                        id: g.id || p,
                        name: g.name,
                        price: parseFloat(g.price).toFixed(2),
                  ...
                  for (
                    s = r.ecommerce.detail.products.length, p = 0;
                    p < s;
                    p++
                  )
                    (g = r.ecommerce.detail.products[p]),
                      ga("ec:addProduct", {
                        id: g.id || p,
                        name: g.name,
                        price: parseFloat(g.price).toFixed(2),
        ...
        if (
          (window.mainMetrikaId &&
            0 < window.mainMetrikaId &&
            "function" == typeof ym &&
            (i
              ? ((n = { title: t }),
                0 < a &&
                  ((n.params = { order_price: a }),
                  l && (n.params.currency = l)),
                ym(window.mainMetrikaId, "hit", e, n))
              : 0 < a
              ? ((n = { order_price: a }),
                l && (n.currency = l),
                ym(window.mainMetrikaId, "reachGoal", e, n))
              ...
              if (
                ...
                if (r && r.event && 0 < a)
                  if ("addToCart" === r.event && r.ecommerce.add) {
                    for (
                      var s = r.ecommerce.add.products.length, v = [], p = 0;
                      p < s;
                      p++
                    )
                      (g = r.ecommerce.add.products[p]),
                    ...
                    for (
                      s = r.ecommerce.detail.products.length, v = [], p = 0;
                      p < s;
                      p++
                    )
                      (g = r.ecommerce.detail.products[p]),
        ...
        if (void 0 !== window.VK && void 0 !== window.VK.Retargeting && !1 == m)
          try {
            if (i) {
              var w,
                g,
                f = (w = document.getElementById("allrecords"))
              ...
              if (r && r.event)
                if (
                  ((h = { products: [], currency_code: "", total_price: 0 }),
                  "purchase" === r.event && r.ecommerce.purchase)
                )
                  if (0 < a && 0 < y) {
                    h.currency_code = l;
                    for (
                      s = r.ecommerce.purchase.products.length, v = [], p = 0;
                      p < s;
                      p++
                    )
                      (g = r.ecommerce.purchase.products[p]),
                  ...
                  if (0 < a && 0 < y) {
                    h.currency_code = l;
                    for (
                      s = r.ecommerce.add.products.length, v = [], p = 0;
                      p < s;
                      p++
                    )
                      (g = r.ecommerce.add.products[p]),
                  ...
                  if (0 < a && 0 < y) {
                    ...
                    (f = "t-view-product"),
                      r.ecommerce.detail[0] &&
                        ...
                        (f += "-" + r.ecommerce.detail[0].uid);
                else if ("removeFromCart" === r.event && r.ecommerce.remmove)
                  if (0 < a && 0 < y) {
                    h.currency_code = l;
                    for (
                      s = r.ecommerce.remove.products.length, v = [], p = 0;
                      p < s;
                      p++
                    )
                      (g = r.ecommerce.remove.products[p]),
                    ...
                    (f = "t-remove-product"),
                      r.ecommerce.remove[0] &&
                        ...
                        (f += "-" + r.ecommerce.remove[0].uid);
                else f = r.event;
              else
                f =
                  -1 !== e.indexOf("tilda/") && -1 !== e.indexOf("/payment/")
                    ? "t-purchase-" +
                      e
                        .replace("/tilda/", "")
                        .replace("tilda/", "")
                    ...
                    ? "t-lead-" +
                      e
                        ...
                        .replace("tilda/", "")
                        .replace("/submitted/", "")
                    : -1 !== e.indexOf("tilda/popup") ||
                      -1 !== e.indexOf("tilda/click")
                    ? "t-" + e.replace("/tilda/", "").replace("/", "-")
                    : "t-" + e.replace("/", "-");
              0 < y && h && h.currency_code
                ? (VK.Retargeting.Event("purchase"),
                  VK.Retargeting.ProductEvent(y, f, h))
                : (VK.Retargeting.Event(f),
                  "t-purchase" === f.substring(0, 10)
                    ? VK.Goal("purchase")
                    : "t-lead" === f.substring(0, 6) && VK.Goal("lead"));
        ...
        try {
          ...
          if (
            ...
            var a,
              i = t.split("&");
            for (a in i)
              "utm_" === i[a].split("=")[0].substring(0, 4) &&
                (r = r + i[a] + "|||");
            0 < r.length &&
