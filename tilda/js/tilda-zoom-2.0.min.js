  ...
  Array.prototype.forEach.call(t, function (t) {
    t.addEventListener("click", function (t) {
      for (var o = t.target; o && o !== this; o = o.parentNode)
        if (
          o.matches('.t-zoomable:not([data-img-zoom-url=""])') ||
          o.matches(".t-slds__thumbs_gallery-zoomable")
        ) {
    ...
    window.tzoomopenonce ||
      ...
      e.on("panmove", function (t) {
        ...
        if (
          ...
          1 === t.maxPointers &&
          !n &&
          (Math.abs(t.deltaX) > 40 && e.setAttribute("data-on-drag", "y"), r)
        ) {
          var c = r + t.deltaX;
...
function t_zoom__getEventOnBtn() {
  ...
  Array.prototype.forEach.call(t, function (t) {
    var o;
    document
      .querySelector(".t-carousel__zoomer__control_" + t.name)
...
function t_zoom__addingImgsIntoCarousel(t) {
  ...
  Array.prototype.forEach.call(e, function (t) {
    ...
    ("IMG" !== t.nodeName && "DIV" !== t.nodeName) ||
      ...
      (r = t.getAttribute("data-img-zoom-descr") || "")),
      e &&
        (a = '<div class="t-zoomer__title t-name t-descr_xxs">' + e + "</div>"),
      r &&
        (i =
          '<div class="t-zoomer__descr t-descr t-descr_xxs">' + r + "</div>"),
  ...
  if (e && r.length) {
    ...
    Array.prototype.forEach.call(r, function (t) {
      var o = t.querySelector(".t-carousel__zoomer__img"),
        ...
        l = r.offsetHeight;
      a || i || (r.style.padding = 0),
        (r.style.height = l + "px"),
        (o.style.maxHeight = "calc(100vh - " + (l + n) + "px"),
        e &&
          -1 !== e.indexOf(".svg") &&
    ...
    var a = t.getAttribute("data-img-zoom-url"),
      i =
        !!a &&
        document.querySelector('.t-carousel__zoomer__img[src="' + a + '"]'),
...
function t_zoom_showSlide(t) {
  ...
  switch (
    ...
    case "next":
      ...
      break;
    case "prev":
      (n = (e.length + (n - 1)) % e.length),
        o.setAttribute("data-on-transition", "y");
  }
    ...
    n.on("panmove", function (n) {
      ...
      if (
        ("y" !== o.getAttribute("data-on-drag") ||
          "y" === t.getAttribute("data-on-drag")) &&
        ((n.angle > -120 && n.angle < -60) ||
          (n.angle < 120 && n.angle > 60)) &&
        1 === n.maxPointers &&
        !e
      ) {
...
function t_zoom_checkForScale() {
  ...
  if (
    ...
    ((o.onload = function () {
      if (!t)
        return r < o.naturalHeight || e < o.naturalWidth
    ...
    if (((t = !0), r < o.naturalHeight || e < o.naturalWidth))
      return (
        window.isDoubletapScaleAdded || t_zoom_doubletapScaleInit(),
        void t_zoom_scale_init()
      );
              ...
              n.setAttribute("data-on-transition", ""),
                ...
                t.classList.contains("scale-active")
                  ...
                  : (t.classList.add("scale-active"),
                    a.classList.add("scale-active"),
                    window.isMobile
                      ? t_zoom_mobileZoomPositioningInit(r)
                      : t_zoom_desktopZoomPositioningInit(r, e));
              break;
            }
        },
        !1
...
function t_zoom_desktopZoomPositioningInit(t, o) {
  ...
  function c(t, o) {
    (i =
      (100 * (void 0 !== t.touches ? t.touches[0].clientX : t.clientX)) /
      window.innerWidth),
      (l = (-i * (o.offsetWidth - window.innerWidth)) / 100),
      (o.style.left = l + "px");
  }
  function s(t, o) {
    (n =
      (100 * (void 0 !== t.touches ? t.touches[0].clientY : t.clientY)) /
      window.innerHeight),
      (a = (-n * (o.offsetHeight - window.innerHeight)) / 100),
      (o.style.top = a + "px");
  }
  (t.style.left = e + "px"),
    (t.style.top = r + "px"),
  ...
  if (o) {
    ...
    if (a && r) {
      ...
      (n.onmousemove = null),
        ...
        (n.style.left = ""),
        (n.style.top = ""),
        (n.style.maxHeight = "calc(100vh - " + (i + l) + "px)");
    }
  }
...
function t_zoom_lockScroll() {
  ...
  if (
    ...
    ((window.isiOSVersion && window.isiOSVersion) || t) &&
    ...
    document.body.classList.add("t-body_scroll-locked"),
      ...
      document.body.setAttribute("data-popup-scrolltop", o);
  }
}
...
function t_zoom_setModalColor(t) {
  ...
  (n = t_zoom_hexToRgb(n)),
    document.getElementById("allrecords") !==
      ...
      document
        ...
        .contains(document.querySelector(".t-store__product-snippet")) &&
      t &&
  ...
  "#000000" === m
    ...
    Array.prototype.forEach.call(l, function (t) {
      "none" === t.getAttribute("fill")
        ? t.setAttribute("fill", "none")
        : t.setAttribute("fill", _);
...
function t_zoom_luma_rgb(t) {
  ...
  return e.length < 3
    ? "black"
    : 0.2126 * e[0] + 0.7152 * e[1] + 0.0722 * e[2] < 128
    ? "black"
    : "white";
}
